-- ============================================================
-- Ryo — one-shot bootstrap for a fresh Supabase project.
-- Paste the whole thing into the Supabase SQL Editor and Run.
-- Combines: 0001_init.sql + 0002_booking_locks.sql + seed.sql
-- Idempotent-ish: safe to re-run (seed truncates first).
-- Generated 2026-05-21T09:57Z
-- ============================================================
